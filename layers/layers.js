...
lyr_2016_2.set('fieldAliases', {'Build_STR': 'Build_STR', 'Build_NO': 'Build_NO', });
lyr_2016_3.set('fieldAliases', {'Build_STR': 'Build_STR', 'Build_NO': 'Build_NO', });
lyr_2016_2.set('fieldImages', {'Build_STR': 'TextEdit', 'Build_NO': 'TextEdit', });
lyr_2016_3.set('fieldImages', {'Build_STR': 'TextEdit', 'Build_NO': 'TextEdit', });
lyr_2016_2.set('fieldLabels', {'Build_STR': 'header label', 'Build_NO': 'header label', });
lyr_2016_3.set('fieldLabels', {'Build_STR': 'header label', 'Build_NO': 'header label', });
